  ...
  app.post('/api/mneme/analyze', async (req, res) => {
    ...
    try {
      ...
      const response = await aiClient
        ...
        .generateContent(`Você é o Consultor Mnēmē do ecossistema ECOBR232.
        ...
        4. ARBITRAGEM DE PREÇO POR TRECHO: Se o usuário vai passar por outras cidades, recomende parar e comprar itens específicos lá.
