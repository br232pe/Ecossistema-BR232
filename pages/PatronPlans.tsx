...
const PatronPlans: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050806] text-white pb-24 overflow-x-hidden">
      {/* Header Stat Bar */}
      <header className="sticky top-0 z-50 bg-[#050806]/80 backdrop-blur-xl border-b border-white/5 px-6 py-4 px-safe">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
             <nav className="hidden lg:flex items-center gap-6 mr-4">
                 ...
                 <button onClick={() => navigate('/planos')} className="text-[9px] font-black uppercase tracking-widest text-[#ff751f] hover:text-primary transition-colors italic px-2 py-1 font-black">Planos</button>
      ...
      {/* Header / Intro */}
      <section className="relative pt-16 pb-16 px-6 text-center border-b border-white/5">
