      ...
      <header className="sticky top-0 z-50 bg-[#05100a]/90 backdrop-blur-3xl border-b border-white/5 py-6 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
           ...
           <div className="flex flex-col items-center">
              <h1 className="text-xs font-black uppercase tracking-[0.4em] italic leading-none">Central Legal</h1>
              <p className="text-[8px] font-bold text-primary tracking-widest uppercase mt-1">LTS 2026.1</p>
           </div>
